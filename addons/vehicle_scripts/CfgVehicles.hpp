class CfgVehicles{
		...
		class ACE_Actions: ACE_Actions{
            ...
            */
            class 16aa_Dismount_GPMG {
                ...
                statement = QUOTE([ARR_3(_target,_player,3)] call FUNC(dismountGPMGTimer));
                showDisabled = 0;
                exceptions[] = {};
                priority = 5;
            };
            class 16aa_Mount_GPMG {
                ...
                statement = QUOTE([ARR_3(_target,_player,3)] call FUNC(mountGPMGTimer));
                showDisabled = 0;
                exceptions[] = {};
                priority = 5;
            };
    ...
    class 16aa_lr_base : Car_F {
        class ACE_Actions: ACE_Actions{
            class ACE_MainActions: ACE_MainActions{};
        };
    };
    class 16aa_WMIK_base: 16aa_lr_base {
        class ACE_Actions: ACE_Actions{
            class ACE_MainActions;
            /*
            ACE_MainActions{
            ...
            */
            class 16aa_Dismount_GPMG {
                ...
                distance = 5;
                condition = QUOTE([ARR_2(_target,_player)] call FUNC(canDismount));
                statement = QUOTE([ARR_3(_target,_player,0)] call FUNC(dismountGPMGTimer));
                showDisabled = 0;
                exceptions[] = {};
                priority = 5;
            };
            class 16aa_Mount_GPMG {
                ...
                distance = 5;
                condition = QUOTE([ARR_2(_target,_player)] call FUNC(canMount));
                statement = QUOTE([ARR_3(_target,_player,0)] call FUNC(mountGPMGTimer));
                showDisabled = 0;
                exceptions[] = {};
                priority = 5;
            };
